...
llab.addFooter = function() {
     ...
     var footer = '<footer><div class="footer wrapper margins"><div class="footer-col col1"><img src="/bjc-r/img/header-footer/blue_synapse_logo.png" alt="Synapse School" /></div><div class="footer-col col2"><img class="noshadow" src="/bjc-r/img/header-footer/EDC_logo.png" alt="EDC" /></div><div class="footer-col col3"><img class="noshadow" src="/bjc-r/img/header-footer/UCB_logo.png" alt="UCB" /></div><div class="footer-col col4"><p>The Beauty and Joy of Computing for Middle School by Synapse School is a derivative of The Beauty and Joy of Computing by University of California, Berkeley and Education Development Center, Inc. used under a Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License. The Beauty and Joy of Computing for Middle School is licensed under a Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License by Synapse School.</p></div><div class="footer-col col5"><img src="/bjc-r/img/header-footer/cc_88x31.png" alt="Creative Commons Attribution" /></div></div></footer>';
